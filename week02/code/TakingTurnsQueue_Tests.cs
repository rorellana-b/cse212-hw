...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: it was not returning the expected result, Sue in the fisrt name
    ...
    // Defect(s) Found: The orden, we spect Bob but recieved Sue
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: the orden, we spect Bob but recieved Sue (fixed in PersonQueue.cs)
    ...
    // Defect(s) Found: the orden, we spect Tim but recieved Sue (fixed in PersonQueue.cs)
    ...
    // Defect(s) Found: None error found
